...
Current source: **0.3.1-overlay-drag** — drag anywhere on caption bubble moves overlay; purple handle resizes; stop-dot still works; full (non-ellipsized) captions.
